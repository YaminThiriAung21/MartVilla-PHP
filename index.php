    ...
    <main>
      ...
      <section class="home-section home-fade home-full-height" id="home">
        <div class="hero-slider">
          <ul class="slides">
            <li class="bg-dark-90 bg-dark shop-page-header" style="background-image:url(&quot;images/index.jpg&quot;);">
              <div class="titan-caption">
                <div class="caption-content">
                  ...
                  <a class=" col-sm-2 col-sm-offset-5 section-scroll btn btn-border-w btn-round" href="#team">Shop Now</a>
                </div>
              </div>
            </li>
          </ul>
